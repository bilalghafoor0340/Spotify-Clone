  ...
  return (
    <div className='w-[25%] h-full p-2.5 gap-2 flex-col  text-white'>
        ...
        <div className='bg-[#121212] h-[15%] rounded-2xl flex flex-col gap-2 justify-around '>
            <div onClick={() => navigate('/')} className='flex items-center gap-3 pl-7 cursor-pointer'>
        ...
        <div className="h-[85%] bg-[#121212] rounded-2xl">
            ...
            <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start  justify-start gap-1 pl-4">
                ...
                <button className="px-3.5 py-1.5 bg-white rounded-full text-black mt-4 text-[15px]">Create Playlist</button>
            </div>
            
            <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4">
                <h1>Let Find out Something New</h1>
                <p className="font-light">we'll keep you update on new episode</p>
                <button className="px-3.5 py-1.5 bg-white rounded-full text-black mt-4 text-[15px]">Browse Podcasts</button>
            </div>
        </div>
